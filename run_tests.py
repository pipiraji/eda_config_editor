...
TEST_FILES = {
    "config_editor_for_qrc/qrc.cmd": "config_editor_for_qrc/qrc.cmd.bak",
    "config_editor_for_starrc/starrc.cmd": "config_editor_for_starrc/starrc.cmd.bak",
    "config_editor_for_setenv/setenv.csh": "config_editor_for_setenv/setenv.csh.bak",
    "config_editor_for_icv/icv.pxl": "config_editor_for_icv/icv.pxl.bak",
}
...
def main():
    ...
    try:
        ...
        res = run_cmd(
            [
                "config_editor_for_qrc/config_editor_for_qrc.py",
                "config_editor_for_qrc/qrc.cmd",
                "set",
                "--command",
                "input_db",
                "--option",
        ...
        segment = read_file_segment("config_editor_for_qrc/qrc.cmd", keyword="run_name")
        ...
        res = run_cmd(
            [
                "config_editor_for_starrc/config_editor_for_starrc.py",
                "config_editor_for_starrc/starrc.cmd",
                "uncomment",
                "--value",
                "YES",
            ]
        )
        segment = read_file_segment("config_editor_for_starrc/starrc.cmd")
        report_content.append(
        ...
        res = run_cmd(
            [
                "config_editor_for_setenv/config_editor_for_setenv.py",
                "config_editor_for_setenv/setenv.csh",
                "set",
                "--variable",
                "NEW",
                "--value",
        ...
        segment = read_file_segment(
            "config_editor_for_setenv/setenv.csh", keyword="NEW"
        )
        report_content.append(
        ...
        segment = read_file_segment(
            "config_editor_for_setenv/setenv.csh", keyword="VAR_ONLY4"
        )
        ...
        with open("config_editor_for_setenv/setenv.csh", "w", encoding="utf-8") as f:
        ...
        segment = read_file_segment(
            "config_editor_for_setenv/setenv.csh", keyword="PATH"
        )
        ...
        res = run_cmd(
            [
                "config_editor_for_icv/config_editor_for_icv.py",
                "config_editor_for_icv/icv.pxl",
                "uncomment",
                "--variable",
                ".*_CHECK",
            ]
        ...
        segment = read_file_segment(
            "config_editor_for_icv/icv.pxl", keyword="RUN_LVS_CHECK"
        )
        report_content.append(
        ...
        segment = read_file_segment(
            "config_editor_for_icv/icv.pxl", keyword="GRID_RESOLUTION"
        )
        report_content.append(
